...
1. Основи JavaScript. Масиви. Цикли while, do while, for.
1. Основи JavaScript. Функції в JS. Приведення типів.
Робота з функціями. Рекурсія та стек. Замикання.
1. Об'єкти.
1. Робота з різними типами даних. Map і Set. JSON.
1. Обробка помилок. Дебагінг програм.
